...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        ...
        for book_copy in range(number_of_book_copies):
            ...
            b = datetime.timedelta(days=book_copy % 5)
            return_date = a + b
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        a = datetime.date.today()
        b = datetime.timedelta(weeks=2)
        valid_date_in_future = a + b
    ...
    def test_form_invalid_renewal_date_future(self):
        self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        a = datetime.date.today()
        b = datetime.timedelta(weeks=5)
        invalid_date_in_future = a + b
        response = self.client.post(
            reverse('renew-book-librarian',
                    kwargs={'pk': self.test_bookinstance1.pk}),
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_redirects_to_detail_view_on_success(self):
        ...
        response = self.client.post(reverse('author-create'),
                                    ...
                                    'last_name': 'Surname'})
        # Manually check redirect because we dont know what author was created
        self.assertEqual(response.status_code, 302)
