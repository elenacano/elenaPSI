...
class Genre(models.Model):
    ...
    name = models.CharField(
        max_length=200,
        help_text="Ingrese el nombre del " +
                  "género (p. ej. Ciencia Ficción, Poesía Francesa etc.)")

    def __str__(self):
        """
        Cadena que representa a la instancia particular
        del modelo (p. ej. en el sitio de Administración)
        """
        return self.name
...
class Book(models.Model):
    ...
    isbn = models.CharField(
        'ISBN',
        max_length=13,
        help_text='13 Caracteres <a href="https://www.isbn-international.' +
